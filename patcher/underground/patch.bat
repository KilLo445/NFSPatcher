@echo off
title Need for Speed: Underground Patcher by KilLo445
:checkinst
IF EXIST "speed.exe" (
  goto startpatch
) ELSE (
...
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://github.com/KilLo445/NFSPatcher/raw/main/patcher/underground/DirectInputMapper/dimap.dll', 'dimap.dll')"
